...
public:
  ...
  format_arg_store(const Args &... args)
      ...
      ,
#endif
      data_{internal::make_arg<is_packed,
                               Context,
...
format_to(std::back_insert_iterator<Container> out, const S &format_str, Args &&... args) {
  return vformat_to(
...
vformat(const S &format_str, basic_format_args<buffer_context<type_identity_t<Char>>> args) {
...
inline void print(const S &format_str, Args &&... args) {
  return internal::is_unicode<Char>()
             ? vprint(to_string_view(format_str),
                      internal::make_args_checked<Args...>(format_str, args...))
             : internal::vprint_mojibake(stdout,
                                         to_string_view(format_str),
                                         internal::make_args_checked<Args...>(format_str, args...));
}
FMT_END_NAMESPACE
